                ...
                <div className='card-wrapper'>
                    <div className="card-column">
                        <div className="smallCard">
                            <img aria-hidden="true" src={uxIcon.src} />
                        ...
                        <div className="smallCard">
                            <img aria-hidden="true" src={brandingIcon.src} />
                    ...
                    <div className='card-column'>
                        <div className="smallCard">
                            <img aria-hidden="true" src={devIcon.src} />
                        ...
                        <div className="smallCard">
                            <img aria-hidden="true" src={systemsIcon.src} />
                    ...
                    <div className='card-column'>
                        <div className="smallCard">
                            <img aria-hidden="true" src={inclusionIcon.src} />
                        ...
                        <div className="smallCard">
                            <img aria-hidden="true" src={behaviorIcon.src} />
